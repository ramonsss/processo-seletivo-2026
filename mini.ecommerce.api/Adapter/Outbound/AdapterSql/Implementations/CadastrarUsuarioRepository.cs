...
public class CadastrarUsuarioRepository(IPostgreSQLConnection connection) : ICadastrarUsuarioRepository
{
    ...
    { 
        ...
        parameters.Add("p_tipo_usuario", usuarioRequest.tipoUsuario?.ToString(), DbType.String, ParameterDirection.Input);
        ...
        parameters.Add("p_chave_idempotencia", usuarioRequest.header?.chaveIdempotencia, DbType.String, ParameterDirection.Input);
